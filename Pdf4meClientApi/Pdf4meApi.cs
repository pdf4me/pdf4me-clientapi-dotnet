...
#pragma warning disable
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        {
                            var responseData_ = response_.Content == null ? null : await response_.Content.ReadAsStringAsync().ConfigureAwait(false);
                            var result_ = default(SaveMachineRes);
                            try
                            {
                                result_ = Newtonsoft.Json.JsonConvert.DeserializeObject<SaveMachineRes>(responseData_, _settings.Value);
                                return result_;
                            }
                            catch (System.Exception exception_)
                            {
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        {
                            var responseData_ = response_.Content == null ? null : await response_.Content.ReadAsStringAsync().ConfigureAwait(false);
                            var result_ = default(GetMachineRes);
                            try
                            {
                                result_ = Newtonsoft.Json.JsonConvert.DeserializeObject<GetMachineRes>(responseData_, _settings.Value);
                                return result_;
                            }
                            catch (System.Exception exception_)
                            {
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        {
                            var responseData_ = response_.Content == null ? null : await response_.Content.ReadAsStringAsync().ConfigureAwait(false);
                            var result_ = default(GetJobFlowRes);
                            try
                            {
                                result_ = Newtonsoft.Json.JsonConvert.DeserializeObject<GetJobFlowRes>(responseData_, _settings.Value);
                                return result_;
                            }
                            catch (System.Exception exception_)
                            {
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        {
                            var responseData_ = response_.Content == null ? null : await response_.Content.ReadAsStringAsync().ConfigureAwait(false);
                            var result_ = default(GetJobFlowPlanRes);
                            try
                            {
                                result_ = Newtonsoft.Json.JsonConvert.DeserializeObject<GetJobFlowPlanRes>(responseData_, _settings.Value);
                                return result_;
                            }
                            catch (System.Exception exception_)
                            {
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        {
                            var responseData_ = response_.Content == null ? null : await response_.Content.ReadAsStringAsync().ConfigureAwait(false);
                            var result_ = default(SaveJobFlowRes);
                            try
                            {
                                result_ = Newtonsoft.Json.JsonConvert.DeserializeObject<SaveJobFlowRes>(responseData_, _settings.Value);
                                return result_;
                            }
                            catch (System.Exception exception_)
                            {
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        {
                            var responseData_ = response_.Content == null ? null : await response_.Content.ReadAsStringAsync().ConfigureAwait(false);
                            var result_ = default(SaveJobFlowPlanRes);
                            try
                            {
                                result_ = Newtonsoft.Json.JsonConvert.DeserializeObject<SaveJobFlowPlanRes>(responseData_, _settings.Value);
                                return result_;
                            }
                            catch (System.Exception exception_)
                            {
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        {
                            var responseData_ = response_.Content == null ? null : await response_.Content.ReadAsStringAsync().ConfigureAwait(false);
                            var result_ = default(DeleteJobFlowRes);
                            try
                            {
                                result_ = Newtonsoft.Json.JsonConvert.DeserializeObject<DeleteJobFlowRes>(responseData_, _settings.Value);
                                return result_;
                            }
                            catch (System.Exception exception_)
                            {
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        {
                            var responseData_ = response_.Content == null ? null : await response_.Content.ReadAsStringAsync().ConfigureAwait(false);
                            var result_ = default(DeleteJobFlowPlanRes);
                            try
                            {
                                result_ = Newtonsoft.Json.JsonConvert.DeserializeObject<DeleteJobFlowPlanRes>(responseData_, _settings.Value);
                                return result_;
                            }
                            catch (System.Exception exception_)
                            {
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        {
                            var responseData_ = response_.Content == null ? null : await response_.Content.ReadAsStringAsync().ConfigureAwait(false);
                            var result_ = default(Package);
                            try
                            {
                                result_ = Newtonsoft.Json.JsonConvert.DeserializeObject<Package>(responseData_, _settings.Value);
                                return result_;
                            }
                            catch (System.Exception exception_)
                            {
    ...
    public partial class UserClient
    {
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        {
                            var responseData_ = response_.Content == null ? null : await response_.Content.ReadAsStringAsync().ConfigureAwait(false);
                            var result_ = default(GetUserPrefRes);
                            try
                            {
                                result_ = Newtonsoft.Json.JsonConvert.DeserializeObject<GetUserPrefRes>(responseData_, _settings.Value);
                                return result_;
                            }
                            catch (System.Exception exception_)
                            {
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        {
                            var responseData_ = response_.Content == null ? null : await response_.Content.ReadAsStringAsync().ConfigureAwait(false);
                            var result_ = default(SaveUserPrefRes);
                            try
                            {
                                result_ = Newtonsoft.Json.JsonConvert.DeserializeObject<SaveUserPrefRes>(responseData_, _settings.Value);
                                return result_;
                            }
                            catch (System.Exception exception_)
                            {
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        {
                            var responseData_ = response_.Content == null ? null : await response_.Content.ReadAsStringAsync().ConfigureAwait(false);
                            var result_ = default(GetUserTokenRes);
                            try
                            {
                                result_ = Newtonsoft.Json.JsonConvert.DeserializeObject<GetUserTokenRes>(responseData_, _settings.Value);
                                return result_;
                            }
                            catch (System.Exception exception_)
                            {
        ...
        /// <returns>Success</returns>
        /// <exception cref="Pdf4meApiException">A server side error occurred.</exception>
        public System.Threading.Tasks.Task<GetUserApplicationRes> GetUserApplicationsAsync(System.Guid? loginId)
        {
            return GetUserApplicationsAsync(loginId, System.Threading.CancellationToken.None);
        }

        /// <returns>Success</returns>
        /// <exception cref="Pdf4meApiException">A server side error occurred.</exception>
        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        public async System.Threading.Tasks.Task<GetUserApplicationRes> GetUserApplicationsAsync(System.Guid? loginId, System.Threading.CancellationToken cancellationToken)
        {
            var urlBuilder_ = new System.Text.StringBuilder();
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        {
                            var responseData_ = response_.Content == null ? null : await response_.Content.ReadAsStringAsync().ConfigureAwait(false);
                            var result_ = default(GetUserApplicationRes);
                            try
                            {
                                result_ = Newtonsoft.Json.JsonConvert.DeserializeObject<GetUserApplicationRes>(responseData_, _settings.Value);
                                return result_;
                            }
                            catch (System.Exception exception_)
                            {
