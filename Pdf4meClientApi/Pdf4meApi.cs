...
#pragma warning disable // Disable all warnings
    ...
    public partial class ImageClient
    {
        ...
        /// <returns>Success</returns>
        /// <exception cref="Pdf4meApiException">A server side error occurred.</exception>
        public System.Threading.Tasks.Task<System.Collections.ObjectModel.ObservableCollection<byte[]>> CreateThumbnailAsync(int? width, string pageNr, string imageFormat, FileParameter file)
        {
        ...
        /// <exception cref="Pdf4meApiException">A server side error occurred.</exception>
        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        public async System.Threading.Tasks.Task<System.Collections.ObjectModel.ObservableCollection<byte[]>> CreateThumbnailAsync(int? width, string pageNr, string imageFormat, FileParameter file, System.Threading.CancellationToken cancellationToken)
        {
            var urlBuilder_ = new System.Text.StringBuilder();
